...
extension KKXScanView {
    ...
    /// 扫码区域4个角位置类型
    public enum PhotoframeAngleStyle {
    ...
    public struct Style {
        ...
        /// 扫码区域的4个角类型
        public var photoframeAngleStyle = PhotoframeAngleStyle.outer
        ...
        /// 扫码动画效果:线条或网格
        public var anmiationStyle = AnimationStyle.lineMove
